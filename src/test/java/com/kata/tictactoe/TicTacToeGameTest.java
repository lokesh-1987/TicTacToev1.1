...
public class TicTacToeGameTest {
    ...
    public void ticTacToeGameShouldReturn_WinningMessage_IfPlayerOCompletesLastRow() {
        assertThat(ticTacToeGame.playGame(0,0,'X'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(4,2,'0'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(0,4,'X'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(4,0,'0'), is(EMPTY_STRING));
    ...
    public void ticTacToeGameShouldReturn_WinningMessage_IfPlayerXCompletesFirstColumn() {
        assertThat(ticTacToeGame.playGame(0,0,'X'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(4,2,'0'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(2,0,'X'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(2,2,'0'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(4,0,'X'), is(PLAYER_X_WON));
    }

    @Test
    public void ticTacToeGameShouldReturn_WinningMessage_IfPlayerXCompletesSecondColumn() {
        assertThat(ticTacToeGame.playGame(0,2,'X'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(0,0,'0'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(2,2,'X'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(0,4,'0'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(4,2,'X'), is(PLAYER_X_WON));
    }
    ...
    public void ticTacToeShouldReturn_WinningMessage_IfPlayerXCompletesSecondDiagonal() {
        ...
        assertThat(ticTacToeGame.playGame(2,2,'X'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(4,2,'0'), is(EMPTY_STRING));
        assertThat(ticTacToeGame.playGame(4,4,'X'), is(PLAYER_X_WON));
    }
}
